 ...
 * Component. Apare la hover SI la focus de tastatura, ceea ce tooltip-ul nativ
 * `title` nu face niciodata.
 *
 * Focusul de tastatura este `:focus-visible`, nu `:focus-within`: dupa un click
 * de mouse butonul ramane focalizat, iar cu `:focus-within` tooltip-ul ramanea
 * agatat pe ecran dupa ce cursorul pleca. `:focus-visible` nu se aprinde la
 * click, deci tooltip-ul dispare odata cu hover-ul.
 *
    ...
    <span className={cn("group/tt relative inline-flex", className)}>
      ...
      <span
        ...
        className={cn(
          ...
          "group-has-[:focus-visible]/tt:scale-100 group-has-[:focus-visible]/tt:opacity-100",
          isBottom
            ? "top-full mt-3 translate-y-1 group-hover/tt:translate-y-0 group-has-[:focus-visible]/tt:translate-y-0"
            : "bottom-full mb-3 -translate-y-1 group-hover/tt:translate-y-0 group-has-[:focus-visible]/tt:translate-y-0",
        )}
      >
